...
module MailyHerald
  ...
  class Initializer
    ...
    def method_missing m, *args, &block
      ...
      $stderr.puts "There is an issue with your initializer file. Please adjust it and run your command once more."
      raise
    end
  end
  ...
  class << self
    ...
    def schema_loaded?
      ...
      mlv = lv.to_i if Rails.application.class == Dummy::Application
